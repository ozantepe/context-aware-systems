...
/**
 * Class that manages the drawing of GLONASS satellites
 * on the satellite view (SatView)
 * <p>
 * Satellites are represented by filled rounded rectangles and black text/border
 *
 * @author jkroesche
 * @see SatView
 */
public class GLONASS_SatelliteInfo extends ASatelliteInfo {
    ...
    protected void drawSatellite(GraphicsContext _gc, int _x, int _y) {
        ...
        _gc.strokeRoundRect(_x - (RADIUS >> 1),
                _y - (RADIUS >> 1),
                RADIUS,
                RADIUS,
                ARC_WIDTH,
