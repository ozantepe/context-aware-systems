...
/**
 * Abstract base class for storing satellite related NMEA-0183 data
 *
 * @author jkroesche
 */
public abstract class ASatelliteInfo {
  ...
  /**
   * Abstract method to finally draw the satellite (circle, rectangle, triangle, or alike) in an
   * concrete class
   *
